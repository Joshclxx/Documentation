          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {errors?.map((err, index) => (
              <motion.div
                ...
                className="bg-white rounded-xl p-4 sm:p-5 md:p-6 shadow-md border border-gray-100 hover:shadow-xl hover:scale-[1.02] hover:bg-gray-600 transition-all duration-300 ease-in-out cursor-pointer"
              >
